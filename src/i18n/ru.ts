...
export const ru = {
  ...
  packagingCheck: {
    ...
    /** Секция «Выполнено» (задача E) — pass-находки, те же карточки с кропом-доказательством,
     *  что и у нарушений. Раскрыта по умолчанию, если пунктов не больше 10. */
    reportPassed: 'Выполнено',
